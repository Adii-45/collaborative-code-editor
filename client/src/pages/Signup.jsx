    ...
    <div className="min-h-screen w-full flex">
      ...
      <div className="w-full lg:w-1/2 bg-[#f8fafc] flex items-center justify-center p-8">
        <div className="w-full max-w-[440px] bg-white rounded-3xl p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          <h1 className="text-[32px] font-bold text-slate-900 mb-8 tracking-tight">Create an account.</h1>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-[15px] font-medium text-slate-700 mb-2">Username</label>
              <input
                type="text"
                value={username}
          ...
          <p className="text-center text-slate-500 text-[15px] mt-8">
            ...
            <Link to="/login" className="text-[#3b82f6] hover:text-blue-600 font-medium">
              Sign in
            </Link>
          </p>
        </div>
